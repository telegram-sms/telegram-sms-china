...
import com.qwe7002.telegram_sms_china.chat_command_service;
import com.qwe7002.telegram_sms_china.notification_listener_service;
...
public class service_func {
    ...
    public static void start_service(Context context, Boolean battery_switch, Boolean chat_command_switch) {
        Intent battery_service = new Intent(context, com.qwe7002.telegram_sms_china.battery_service.class);
